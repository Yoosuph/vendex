...
export default function LoginSignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    if (email === 'admin@vendex.com') {
      selectedRole = 'admin';
    } else if (email === 'vendor@vendex.com' || activeTab === 'signup' && role === 'sell') {
      selectedRole = 'vendor';
    }
          ...
          <form className="space-y-md" onSubmit={handleSubmit}>
            ...
            <div className="space-y-sm">
              <div className="space-y-xs">
                ...
                <input
                  className="w-full px-sm py-sm border border-outline-variant rounded-lg bg-white focus:ring-0 focus:border-on-surface transition-all-custom outline-none placeholder:text-outline"
                  id="email"
              ...
              <div className="space-y-xs">
                ...
                <input
                  className="w-full px-sm py-sm border border-outline-variant rounded-lg bg-white focus:ring-0 focus:border-on-surface transition-all-custom outline-none"
                  id="password"
                  placeholder="••••••••"
                  type="password"
                  value={password}
            ...
            {/* CTA Button */}
            <button
              className="w-full py-sm bg-primary-container text-white font-headline-md text-headline-md rounded-lg hover:bg-[#96101F] transition-all-custom shadow-md active:scale-[0.98]"
              type="submit"
            >
            ...
            <div className="grid grid-cols-3 gap-xs">
              <button
                type="button"
                className="flex flex-col items-center justify-center py-2 border border-outline-variant rounded-lg bg-white hover:bg-surface-container-low transition-all-custom text-meta font-label-md"
